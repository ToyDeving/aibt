--Lagga's Hub All Games | Released Nov 2022 | Working.
...
function FindNearestPlayer()
	...
	for _, v in pairs(Players:GetPlayers()) do
		if v ~= LocalPlayer and not LocalPlayer.PlayerFolder.Allied:FindFirstChild(v.Name) and v.Character:FindFirstChild("Humanoid") and v.Character:FindFirstChild("Humanoid").Health > 0 and v.Character:FindFirstChild("HumanoidRootPart") and v then
